    ...
    return (
        <div className="container" >
             <div className="text-center">
                 <h1 className="headline__signup">Sign Up Now</h1>
                 <p className="subheadline__singup">Start Your Journey And Join Us</p>
             </div>
             ...
             <div className="flex-cols">
                ...
                <input type="text" className="register-input" name="name" />
                 ...
                 <div className="flex-col-l">
                 <label  className="register-label" >Your Last Name</label>
             ...
             <div className="flex-cols">
                ...
                <input type="text" className="register-input" name="email" />
                 ...
                 <div className="flex-col-l">
                 <label  className="register-label" >Your Age</label>
                <input type="number" className="register-input" name="age" />
                 </div>
             </div>
